    ...
    <section id="contact" className="contact" ref={sectionRef}>
      ...
      <div className="contact__inner">
        ...
        <div className="contact__actions reveal" style={{ transitionDelay: '0.15s' }}>
          <a href="mailto:agnelvincent779@gmail.com" className="contact__btn contact__btn--primary">
        ...
        <div className="contact__socials reveal" style={{ transitionDelay: '0.2s' }}>
          <a href="https://github.com/agnelvincent" target="_blank" rel="noopener noreferrer" className="contact__social">
          ...
          <a href="https://linkedin.com/in/agnelvincent" target="_blank" rel="noopener noreferrer" className="contact__social">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="tel:+917034654422" className="contact__social">
